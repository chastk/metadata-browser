      			...
      			"""),format.raw/*29.10*/("""<div id=""""),_display_(/*29.20*/thingType),format.raw/*29.29*/("""" class="tab-pane fade in">
      			    """),_display_(/*30.15*/thingType/*30.24*/ match/*30.30*/{/*31.25*/case "PlatformModels" =>/*31.49*/ {_display_(Seq[Any](format.raw/*31.51*/(""" 
                        ...
                        """)))}/*101.25*/case "Detectors" =>/*101.44*/ {_display_(Seq[Any](format.raw/*101.46*/(""" 
                            ...
                            <div><p>(click for more information)</p></div>
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                        """),_display_(/*105.42*/for(triple <- query_results.triples_list) yield /*105.83*/{_display_(Seq[Any](format.raw/*105.84*/("""
                                            """),_display_(/*106.46*/if(triple.resultType == "Detectors")/*106.82*/{_display_(Seq[Any](format.raw/*106.83*/("""
                                                """),_display_(/*107.50*/detector_entry(triple)),format.raw/*107.72*/(""" 
                                            """)))}),format.raw/*108.46*/("""
                                        """)))}),format.raw/*109.42*/("""
                                """),format.raw/*110.33*/("""</div>
                        """)))}/*112.10*/case _ =>/*112.19*/{_display_(Seq[Any](format.raw/*112.20*/("""
      			            """),_display_(/*113.23*/metadata_table(query_results)),format.raw/*113.52*/("""
      				    """)))}}),format.raw/*115.15*/("""
      			"""),format.raw/*116.10*/("""</div>
      		""")))}),format.raw/*117.10*/("""
      		"""),_display_(/*118.10*/for((thingType, hierarchy_results) <- documentHierarchy) yield /*118.66*/ {_display_(Seq[Any](format.raw/*118.68*/("""
      			"""),format.raw/*119.10*/("""<div id=""""),_display_(/*119.20*/thingType),format.raw/*119.29*/("""" class="tab-pane fade in">
  					"""),_display_(/*120.9*/metadata_hierarchy(hierarchy_results)),format.raw/*120.46*/("""
      			"""),format.raw/*121.10*/("""</div>
      		""")))}),format.raw/*122.10*/("""
          """),format.raw/*123.11*/("""</div>
        </div>
      </div>
    </div>
